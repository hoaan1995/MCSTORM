...
console.log('██║░╚███║╚█████╔╝██████╔╝███████╗██║░░██║╚██████╔╝██████╦╝░╚██╗██████╔╝'.rainbow);;
console.log('╚═╝░░╚══╝░╚════╝░╚═════╝░╚══════╝╚═╝░░╚═╝░╚═════╝░╚═════╝░░░╚═╝╚═════╝░'.rainbow);;
console.log('Informations:'.red);
console.log('Proxies-list| HTTP'.blue);
console.log('Target| %s'.yellow, process.argv[2]);
console.log('Proxies| %s'.green, process.argv[3]);
console.log('Time| %s seconds'.white, process.argv[4]);
console.log('Proxie-Amount| 6617'.rainbow);
